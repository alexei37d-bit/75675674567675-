...
games_keyboard = InlineKeyboardMarkup(
    inline_keyboard=[
        ...
        [InlineKeyboardButton(text="Кубики", icon_custom_emoji_id="5451788978804001506", callback_data="dice_choose_bet")]
    ]
)
